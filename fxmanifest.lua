...
description 'LXRCore v3 moonshine: a copper still in the woods, catalog recipes on a timer, the law on the wire'
version '3.0.0'
repository 'https://github.com/LXRCore/lxr-moonshine'
